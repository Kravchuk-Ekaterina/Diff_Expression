...
# Write the table out.
write.table(sorted.df, file="../data/result.txt", sep="\t", col.names=NA, quote=FALSE)
...
write.table(dt, file="../data/norm-matrix-deseq2.txt", sep="\t",  row.name=FALSE, col.names=TRUE,quote=FALSE)
